...
Complex terrain introduces strong flow inclination, turbulence, and terrain-driven variability that are difficult to capture consistently across models.
This benchmark provides a common test case to evaluate model performance and improve confidence in simulation workflows.

Why WINSENT
-----------

WINSENT combines a research turbine, rich inflow and wake measurements, and an environment where topography and land-surface effects are relevant to model skill.
The benchmark is intended to support consistent cross-model comparison in complex terrain, including inflow-focused and turbine-coupled studies.
